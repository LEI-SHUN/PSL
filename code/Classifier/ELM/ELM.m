function [TrainingTime, TestingTime, TrainingAccuracy, TestingAccuracy,label_index_actual] = ELM(T,P,TV, Elm_Type, NumberofHiddenNeurons, ActivationFunction)
...
%%%%%%%%%% Calculate training & testing classification accuracy
    ...
    label_index_actual=zeros(1,size(TV.T,2));
    for i = 1 : size(TV.T, 2)
        [x, label_index_expected]=max(TV.T(:,i));
        [x, label_index_actual(i)]=max(TY(:,i));
        if label_index_actual(i)~=label_index_expected
